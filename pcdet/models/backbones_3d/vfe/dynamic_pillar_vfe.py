...
print("Attempting to import torch_scatter...")
try:
    import torch_scatter
    print(f"Successfully imported torch_scatter version: {torch_scatter.__version__}")
except ImportError as e:
    print(f"Failed to import torch_scatter: {e}")
    raise ImportError(
        'Please install torch_scatter following the instructions at '
