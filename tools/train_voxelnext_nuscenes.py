...
def log_metrics_to_file(result_dict, csv_file, args):
    ...
    # For NuScenes dataset, extract per-class AP@4.0 values
    if 'nuscenes' in args.cfg_file.lower():
        ...
        for cls_name in classes:
            # Define the column name for the CSV - Changed to AP@4.0
            column_key = f'{cls_name}_AP@4.0'
            
            # Look up the actual key in result_dict
            result_key = f'{cls_name}_AP@4.0'
